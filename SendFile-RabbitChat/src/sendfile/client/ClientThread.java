...
public class ClientThread implements Runnable{
    ...
    public void run() {
        try {
                    ...
                    case "CMD_FILE_XD":
                        ...
                        if(confirm == 0){ 
                            ...
                            try {
                                ...
                                String format = "CMD_SEND_FILE_ERROR "+sender+" The user declined your request or lost connection!";
                                dos.writeUTF(format);
                            } catch (IOException e) {
                                System.out.println("[CMD_FILE_XD]: "+e.getMessage());
                            }
            ...
            SoundEffect.ErrorSound.play();
            main.appendMessage(" The connection to the Server is lost, please try again!", "error", Color.RED, Color.RED);
        }
    }
}